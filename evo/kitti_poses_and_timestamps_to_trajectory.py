...
if __name__ == "__main__":
    ...
    parser.add_argument("--poses_file", help="pose path file in KITTI format", default='/database3/KITTI_odometry/dataset/poses/05.txt')
    parser.add_argument(
        "--timestamp_file", help="KITTI timestamp file of the poses", default='/database3/KITTI_odometry/dataset/sequences/05/times.txt')
    parser.add_argument(
        "--trajectory_out", help="output file path for trajectory in TUM format", default='/home/wjpark/Github/monoVO/trajectory_TUM/05.txt')

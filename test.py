...
vo = VisualOdometry(cam, '/database3/KITTI_odometry/dataset/poses/00.txt')

traj = np.zeros((600,600,3), dtype=np.uint8)

for img_id in range(4541):
	img = cv2.imread('/database3/KITTI_odometry/dataset/sequences/00/image_2/'+str(img_id).zfill(6)+'.png', 0)
